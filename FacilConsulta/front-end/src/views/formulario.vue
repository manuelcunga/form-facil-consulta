          ...
          <div class="col-md-6 ">
            <form @submit.prevent="CreateProfissional">
              ...
              <div class="profissional-content">
                ...
                <div class="input-group input-form mt-5 mb-4 next">
                  <button type="submit" 
                  class="button">
                    PRÓXIMO
                  </button>
...
import Estado from "../components/profissional/Estado.vue";
import Cidade from "../components/profissional/Cidade.vue";
